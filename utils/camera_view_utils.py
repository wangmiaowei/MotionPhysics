...
from .triplane_field import TriplaneFields
...
def create_spatial_fields(
    sp_res, output_dim, aabb: Float[Tensor, "2 3"], add_entropy=True
):
...
def get_camera_view(
    ...
    with open(cam_path) as f:
        ...
        return GSCamera(
            ...
            FoVy=fovy,
            invdepthmap = None,
            image=TF.to_pil_image(torch.zeros((3,  width,height))),  # fake
            image_name="fake",
